...
##################################################################################################################
<<Comment1
	VMware Workstation PRO v14 - Best VM solution for home workstations - Paid Option
...
[ -f "/tmp/VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle" ] && sudo rm -rf /tmp/VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle

wget -O /tmp/VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle http://download3.vmware.com/software/wkst/file/VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle


# Moving the result to /opt

sudo mkdir ~/Download/VMware-Workstation-Full-14
sudo cp /tmp/speedtest-cli ~/Download/VMware-Workstation-Full-14
sudo chmod +x ~/Download/VMware-Workstation-Full-14/VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle

#it should be like:
# sh VMware-Workstation-xxxx-xxxx.architecture.bundle [--option] 
# Your CD KEY: Fexample in such format
# YZ35U-4PED5-M881Z-87WEV-NY2XA then it should be run in console mode -c option 

<<CommentToDo
	1) what's the default name of the file to download ?
	...
	Solved - 2) What are the silent mode switches
	Solved - 3) What are the console switches
	Solved - 4) What are the key switches
	Solved - 5) How to hide My CD key from public repository for this install
CommentToDo

cd ~/Download/VMware-Workstation-Full-14

sudo ./VMware-Workstation-Full-14.0.0-6661328.x86_64.bundle --console --set-setting vmware-workstation serialNumber YZ35U-4PED5-M881Z-87WEV-NY2XA
...
references and incorporates this EULA and is accepted by VMware as set forth in
Section 4.
...
accordance with the  applicable Documentation; and (b) has not been modified or
...
Key(s)) and return, or if requested by VMware, destroy, any related VMware
...
</b>VMware's Customer Experience Improvement Program ("CEIP") provides
...
http://www.vmware.com/trustvmware/ceip.html.  <b>Join the VMware
